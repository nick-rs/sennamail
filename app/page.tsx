...
export default function Home() {
    return (
      ...
      // Senna ©️ 2025 
        ...
        <h1
          className="hover:animate-pulse text-4xl font-bold text-center md:text-6xl lg:text-7xl"
        ...
        >
          senna.<span className='bg-gradient-to-br from-black to-blue-400 dark:from-white dark:to-blue-400 text-transparent bg-clip-text'>mail</span>
        </h1>
